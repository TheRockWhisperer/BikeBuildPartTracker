...
class SelleItaliaSku:
    ...
    def __init__(self, product_slug: str, option_values: dict, variant_id: int):
...
class SelleItaliaProductSkus(SelleItaliaSku, Enum):
    SLR_BOOST_ENDURANCE_S3_BLACK = ("slr-boost-endurance-ti-316-superflow", {186: 224, 219: 264}, 1)
    SLR_BOOST_ENDURANCE_L3_BLACK = ("slr-boost-endurance-ti-316-superflow", {186: 225, 219: 264}, 2)
