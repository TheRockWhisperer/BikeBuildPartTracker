...
class SelleItaliaSku:
    ...
    def __init__(self, product_slug: str, variant_reference_name: str, option_values: dict):
...
class SelleItaliaProductSkus(SelleItaliaSku, Enum):
    SLR_BOOST_ENDURANCE_S3_BLACK = ("slr-boost-endurance-ti-316-superflow", "slr_boost_s3", {186: 224, 219: 264})
    SLR_BOOST_ENDURANCE_L3_BLACK = ("slr-boost-endurance-ti-316-superflow", "slr_boost_l3", {186: 225, 219: 264})
